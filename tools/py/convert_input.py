...
def convert_numbers_to_hex_strings(data):
    ...
    if isinstance(data, dict):
        return {key: convert_numbers_to_hex_strings(value) for key, value in data.items()}
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(description="Convert integers in JSON to hexadecimal strings.")
